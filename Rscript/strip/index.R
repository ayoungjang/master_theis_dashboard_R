...
setwd("C:/Users/ayoung/Desktop/Thesis/real_data/excels")
getwd()
...
Gradient_Etest_newdata <- calculation(Gradient_Etest);
Gradient_MTS_newdata<- calculation(Gradient_MTS);


n <- Gradient_Etest_newdata[2]
source("./strip_plot.R")
combine_plots(Gradient_Etest_newdata[[1]],Gradient_MTS_newdata[[1]],as.numeric(n), "combined")
